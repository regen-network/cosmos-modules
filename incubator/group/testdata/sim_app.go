...
//
// The code was copied from cosmos-sdk `simapp.SimApp` as there are no extension points to add a custom handler.
type SimApp struct {
	*bam.BaseApp
	cdc *codec.Codec
...
func NewSimApp(
	...
	app.GroupKeeper = group.NewGroupKeeper(keys[group.StoreKeyName], app.subspaces[group.ModuleName], &MyAppProposal{})
...
func (app *SimApp) ExportAppStateAndValidators(bool, []string) (json.RawMessage, []types.GenesisValidator, error) {
	panic("implement me")
}
