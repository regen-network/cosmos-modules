...
const (
	...
	ProposalBase_PROPOSAL_EXECUTOR_RESULT_INVALID ProposalBase_ExecutorResult = 0
	// We have not yet run the executor
	ProposalBase_NotRun ProposalBase_ExecutorResult = 1
	// The executor was successful and proposed action updated state
	ProposalBase_Success ProposalBase_ExecutorResult = 2
	// The executor returned an error and proposed action didn't update state
	ProposalBase_Failure ProposalBase_ExecutorResult = 3
)
...
type ThresholdDecisionPolicy struct {
	...
	// TODO: why do we need min/max? when people can change their vote there is no way we can
	// close a proposal early. Even if everybody has voted already. I would propose a single value instead so that
	// we can calculate the end of the voting period.
	MinVotingWindow types.Duration `protobuf:"bytes,2,opt,name=min_voting_window,json=minVotingWindow,proto3" json:"min_voting_window"`
	MaxVotingWindow types.Duration `protobuf:"bytes,3,opt,name=max_voting_window,json=maxVotingWindow,proto3" json:"max_voting_window"`
}
...
type ProposalBase struct {
	...
	ExecutorResult ProposalBase_ExecutorResult `protobuf:"varint,9,opt,name=executor_result,json=executorResult,proto3,enum=cosmos_modules.incubator.group.v1_alpha.ProposalBase_ExecutorResult" json:"executor_result,omitempty"`
	VoteState      Tally                       `protobuf:"bytes,10,opt,name=vote_state,json=voteState,proto3" json:"vote_state"`
	// Timestamp of the block where the voting period ends. Header times of the votes must be before this end time
	// to be included in the election.
	VotingEndTime types.Timestamp `protobuf:"bytes,11,opt,name=voting_end_time,json=votingEndTime,proto3" json:"voting_end_time"`
}
...
func (m *ProposalBase) GetExecutorResult() ProposalBase_ExecutorResult {
	...
	return ProposalBase_PROPOSAL_EXECUTOR_RESULT_INVALID
}
...
func (m *ProposalBase) GetVotingEndTime() types.Timestamp {
	if m != nil {
...
var fileDescriptor_d938547f84707355 = []byte{
	...
	,
}
