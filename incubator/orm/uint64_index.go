...
// NewUInt64Index creates a typed multi key secondary index
func NewUInt64Index(builder Indexable, prefix byte, indexer UInt64IndexerFunc) UInt64Index {
	return AsUInt64Index(NewIndex(builder, prefix, UInt64MultiKeyAdapter(indexer)))
}

// AsUInt64Index wraps any multi key implementation to provide a typed access interface.
func AsUInt64Index(idx MultiKeyIndex) UInt64Index {
	return UInt64Index{multiKeyIndex: idx}
}
